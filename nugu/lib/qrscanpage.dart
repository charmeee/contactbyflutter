...
import 'package:nugu/addingpage.dart';



class qrscanpage extends StatefulWidget {
  qrscanpage({Key? key,this.uid}) : super(key: key);
  var uid;
  @override
            ...
            child: FittedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                      child:TextButton(
                          onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>addingpage()));},
                          child: Text("직접 추가하기"))
                  )
                ],
              ),
